...
BLOG_AUTHOR = "Facundo Flores"  # (translatable)
BLOG_TITLE = "Facundo Flores"  # (translatable)
...
BLOG_EMAIL = "flores.facundogabriel@gmail.com"
BLOG_DESCRIPTION = "Un blog improvisado"  # (translatable)
